...
public class WidgetMediano extends AppWidgetProvider {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        ComponentName thisWidget = new ComponentName(context.getApplicationContext(), WidgetMediano.class);
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        Intent intent = new Intent(context, WidgetMedianoRemoteViewsService.class);
        intent.putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, appWidgetId);
        intent.setData(Uri.parse(intent.toUri(Intent.URI_INTENT_SCHEME)));

        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.widget_mediano);
        ...
        Intent intent8 = new Intent(context, Almacenamiento.class);
        ...
        views.setOnClickPendingIntent(R.id.almacenamiento_click, pendingIntent8);
