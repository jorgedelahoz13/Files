...
public class WidgetPequenoRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public WidgetPequenoRemoteViewsFactory(Context context, Intent intent) {
